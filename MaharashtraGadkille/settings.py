"""
Django settings for MaharashtraGadkille project.
...
CORS_ORIGIN_WHITELIST = (
  'https://maharashtragadkille.s3.amazonaws.com/*','https://www.maharashtragadkille.com'
)
...
WSGI_APPLICATION = 'MaharashtraGadkille.wsgi.application'
